...
foreach ($users as $user) {
	...
	<tr>
		<td> <?=$user->name?> </td>
		<td> <span class='currentroll'><?=$user->roll?>  </span> <form class="rollform" action='combat/editroll/<?=$user->id?>' method="post" id='newroll'>
			{{ csrf_field() }}


			 <input type="text" name="roll" id='roll' value='<?=$user->roll?>'>   </form>    </td>
